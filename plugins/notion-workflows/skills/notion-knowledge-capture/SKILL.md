...
description: Turn conversations, decisions, FAQs, procedures, and insights into structured Notion documentation with links and metadata.
---
...
3. **Determine location**: Use `the available Notion search tool` to find appropriate wiki page/database
4. **Create page**: Use `the available Notion page-creation tool` to save content
...
Example:
the available Notion page-update tool
