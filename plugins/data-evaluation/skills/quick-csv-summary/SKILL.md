---
name: quick-csv-summary
description: Run a lightweight CSV profile with summary statistics, missingness, column types, and quick charts when full cleaning is not needed.
---
